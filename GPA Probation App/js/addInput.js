...
function addInput(divName){
	 ...
	 // If not at limit, a new element is created that stores each new input box as they are created by the user
          ...
          newdiv.innerHTML = "Additional Planned Semester " + (window.counter) + ":" + " <input class='form-control' type='number' min='0' max='200' oninput='validity.valid||(value='');' onFocus='this.select();' id='creditsTakenBox" + (window.counter + 1) + "' value='0'><br>";
